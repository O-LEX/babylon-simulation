...
import { createCloth, createChain, createHighStiffnessRatioChain, createFixedCloth, createTwoCloths, createThreeCloths } from "./geometry";
...
function createGeometryFromUI() {
  ...
  switch (geometryType) {
    ...
    case "three cloths": return createThreeCloths();
